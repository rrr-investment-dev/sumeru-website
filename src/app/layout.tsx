...
export const metadata: Metadata = {
  title: "Shakti Sphere · Sumeru India Growth Fund",
  description: "Sumeru India Growth Fund (SIGF) is Shakti Sphere's flagship Category III AIF, partnering India's next decade of wealth creation through disciplined, quality-focused investing.",
  icons: {
